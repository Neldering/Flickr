...
public final class GameSettings {
    ...
    public static final int ANIMATION_OPEN_BUTTON_DURATION = 1000;
    public static final int ANIMATION_CLOSE_BUTTON_DURATION = 1000;
    public static final int ANIMATION_SHOW_HOME_BUTTON_DURATION = 1000;
    public static final int ANIMATION_HIDE_HOME_BUTTON_DURATION = 1000;
    public static final int ANIMATION_SHOW_TITLE_DURATION = 1000;
    public static final int ANIMATION_HIDE_TITLE_DURATION = 1000;
